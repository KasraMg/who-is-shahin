                ...
                <main className='flex  relative z-[999] sm-x2:!pb-4 gap-48 justify-center md:flex-col md:justify-center sm:!px-6 md:px-10 sm:pt-16  lg:gap-20 pt-32 pb-32'>
                    <div>
                        ...
                        <div className='text-white text-2xl sm:!text-[20px] mt-4 font-swap'>
                            <a href='https://www.linkedin.com/in/kasramg85/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3B%2FIEXvre8QJi13fb48zDm8w%3D%3D'>shahinmg85</a>
                        </div>
                    ...
                    >
                        {({
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <button type="submit" className={` disabled:opacity-50 bg-red-600 rounded-md md:w-full font-swap text-white py-2 mt-8  px-6`}>{t('footer.button')}</button>
                            </form>
