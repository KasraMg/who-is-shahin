  ...
  return (
    ...
    <div className='topbar bg-[top] bg-fullSize bg-[#1d192c] border-b-2 border-red-600 border-solid sm-x2:pb-20'>
      <section className={`${i18n.language == 'fa' ? null : 'pl-44'} px-36 relative z-20  sm-x2:overflow-hidden  pb-[70px] lg:px-10 pt-28 md:pt-10`}>
        <Image width={500} height={500} src="/Images/photo_5847965502901698114_x.jpg" className='me-image-2 z-[9999] relative sm-x2:w-60  sm-x2:h-64  sm-x2:relative  sm-x2:z-50 hidden md:block object-cover w-72 h-80 mx-auto mb-4 rounded-full' alt="" />
        <div className={`md:text-center sm:w-full  sm-x2:mt-8 md:w-full w-max relative text-white font-swap font-extrabold`}>
          ...
          <Image width={144} height={106} className={`${i18n.language == 'fa' ? 'md:left-40 sm-x3:!left-0  left-10' : ' md:right-40 sm-x3:!right-0  right-2'} absolute top-4 md:top-0 w-36  z-10`} src="/Images/title.png" alt="" />
        </div>
        ...
        <Image width={317} height={798} className={`${i18n.language == 'fa' ? 'sm-x2:right-0 TopBar-logo-fa' : 'sm-x2:left-0 TopBar-logo'}  absolute  sm-x2:w-full`} src="/Images/vertical_logo.png" alt="" />
        <Image width={420} height={100} src="/Images/shomal2.jpg" className={`${i18n.language == 'fa' ? 'left-[220px] lg:left-28' : 'right-[220px] lg:right-28'} me-image absolute h-auto  w-[420px] -top-[74px]  md:hidden`} alt="" />
        <Image width={91} height={100} src="/Images/dot-texture.png" className={`${i18n.language == 'fa' ? ' md:!left-[45%]  lg:left-3 left-[97px] ' : ' md:!right-[45%]  lg:right-3 right-[97px]'} dot-bg  md:z-[-1] md:-top-20 top-32 absolute max-w-full h-auto`} alt="" />
      </section>
      ...
      <a href='#footer' onClick={() => window.scrollTo(500, 7900)} className='absolute z-50 cursor-pointer lg:bottom-10  sm-x2:!-bottom-7 md:!-bottom-36 bottom-36  sm-x2:hidden'>
        <p className='scrollDown text-white '>{t('topbar.scroll')}  <Image width={16} height={23} className=' absolute z-50 cursor-pointer w-4 top-0 -left-10' src="/Images/scroll.png" alt="" /></p>
