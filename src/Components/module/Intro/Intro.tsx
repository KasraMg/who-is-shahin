  ...
  return (
    <div data-aos="fade-up" data-aos-duration="3000" className={` overflow-hidden  Intro relative   bg-[#1d192c] `} id='me'>
      ...
      <main className='px-36 lg:px-12 flex md:!pr-0 sm:!pl-0 border-b-2 sm:border-0 border-red-600 border-solid   sm:flex-col '>
        <Image height={1000} width={1000} src="/Images/photo_5922601885498458783_y.jpg" className='w-80 sm:!block sm:object-cover sm:!w-full sm-x2:!h-[300px]   sm:h-[430px] sm:rounded-none md:hidden object-cover lg:w-72 rounded-l-[20rem] relative z-30' alt="" />
        ...
        <Image height={1000} width={1000} src="/Images/Capture.PNG" className='w-80 z-[99] object-cover sm:hidden lg:w-72' alt="" />
      </main>
