      ...
      <div className='flex z-[999] sm-x3:mx-3'>
        <div>
          <div className="flex items-center justify-center">
            <div className=" relative inline-block text-left dropdown  mt-1">
              ...
              ><button style={{boxShadow:'none'}} className={`${isSticky && '!text-[#1d192c]'} outline-none border-0 inline-flex justify-center w-full px-4 py-2 text-sm font-medium leading-5  transition duration-150 ease-in-out   text-white active:text-gray-800`}
        ...
        <div className={`${isSticky && ' !w-[48px]'} relative w-[64px]`} >
          <svg className='w-full cursor-pointer absolute ' xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 226.75 211.94">
            ...
            <path fill={isSticky ? '#1d192c' : 'white'} d="M302.21,287.78c2.58-.95,5.85-4.34,8.83,1.64,1,2,4.54,2.75,6.92,4.07l-.11,1.45c-1.85.26-4.23,1.38-5.47.63C308.74,293.36,305.55,290.42,302.21,287.78Z" transform="translate(-198.42 -270.73)" />
            <path fill={isSticky ? '#1d192c' : 'white'} d="M269.66,318.48c-5.28,4.81-6.86-1.58-10-2.82C262.89,316.51,267.38,312.51,269.66,318.48Z" transform="translate(-198.42 -270.73)" /><path fill={isSticky ? '#1d192c' : 'white'} d="M360.36,329.06l12.11-.7-4.23,3.58.75,1.64L360.26,331Z" transform="translate(-198.42 -270.73)" />
            ...
            <path fill={isSticky ? '#1d192c' : 'white'} d="M373.16,320.2l18.11-6.3.47,1.29-17.83,6.56Z" transform="translate(-198.42 -270.73)" />
            <path d="M320.85,440.05l-3.2,3.64-4-2.85,3.22-4.09Z" transform="translate(-198.42 -270.73)" style={{ fill: "red" }} />
            <rect fill={isSticky ? '#1d192c' : 'white'} x="330.55" y="376.01" width="4.96" height="4.96" transform="translate(196.97 -392.52) rotate(48.45)" />
            <rect fill={isSticky ? '#1d192c' : 'white'} x="337.47" y="376.46" width="4.96" height="4.96" transform="translate(199.65 -397.55) rotate(48.45)" />
            <rect fill={isSticky ? '#1d192c' : 'white'} x="350.14" y="350.15" width="4.16" height="4.16" transform="translate(183.79 -415.72) rotate(48.45)" />
            <rect fill={isSticky ? '#1d192c' : 'white'} x="301.06" y="329.55" width="4.16" height="4.16" transform="translate(151.84 -385.93) rotate(48.45)" />
            <rect fill={isSticky ? '#1d192c' : 'white'} x="357.22" y="350.46" width="4.16" height="4.16" transform="translate(186.4 -420.92) rotate(48.45)" />
            <rect fill={isSticky ? '#1d192c' : 'white'} x="363.9" y="352.88" width="4.16" height="4.16" transform="translate(190.46 -425.1) rotate(48.45)" />
            <path fill={isSticky ? '#1d192c' : 'white'} d="M255.59,315.13c5,.64,5.4,3.62,5.4,3.62v1.5" transform="translate(-198.42 -270.73)" />
          </svg>
        </div>
      </div>
