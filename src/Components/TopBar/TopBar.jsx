  ...
  return (
    <div className='TopBar border-b-2 border-red-600 border-solid sm-x2:pb-20'>
      <section className='px-36 relative z-20  sm-x2:overflow-hidden  pb-[70px] lg:px-10 pt-28 md:pt-10'>
        ...
        <img src="https://demo.themecon.net/onlyme/html/images/dot-texture.png" className='dot-bg  md:z-[-1] md:right-1/2 lg:right-5 right-20  md:-top-20 top-32 absolute' alt="" />
      </section>
