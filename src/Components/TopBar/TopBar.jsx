  ...
  return (
    <div className='TopBar'>
      <section className='px-36 relative z-20 sm:overflow-hidden pb-10 lg:px-10 pt-28 md:pt-10'>
        ...
        <img src="/Images/photo_5847965502901698114_x.jpg" className='me-image-2 sm:w-60 sm:h-64     hidden md:block object-cover  w-72  h-80   mx-auto mb-4 rounded-full' alt="" />
        <div className='text-9xl md:text-6xl md:text-center sm:mt-8  md:w-full w-max relative text-white font-swap font-extrabold'>
          <span className='z-20 relative'>Hi! I’m Kasra</span>
           <img className='absolute top-4 md:right-40 md:top-0 w-36  z-10   right-2 ' src="https://demo.themecon.net/onlyme/html/images/hero-title-pettern-bg.png" alt="" />
           </div>
        <p className='text-5xl md:text-3xl md:text-center md:w-full mt-4 w-max relative text-white font-swap font-extrabold z-10'>  Front-end Developer</p>
