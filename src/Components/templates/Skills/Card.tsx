    ...
    >
      ...
      >
        <span
          className={
            props.rotate
              ? "circle xs:top-[48px]  w-[18px] h-[18px] z-[2] bg-[#f43534]  rounded-full absolute top-[50px] md:-left-[61px] md:right-auto  -left-[61px]"
              : "circle xs:top-[48px]  w-[18px] h-[18px] z-[2] bg-[#f43534] md:-left-[61px] md:right-auto   rounded-full absolute top-[50px] -right-[61px]"
          }
        ></span>
        <span
          className={
            props.rotate
              ? "rectengle xs:w-[105%] absolute w-[115px] h-8 md:-left-12 md:right-auto -left-12 top-[42px]"
              : "rectengle xs:w-[105%] absolute w-[115px] h-8 -right-12 top-[42px] md:-left-12 md:right-auto"
          }
        ></span>
      </div>
    </div>
