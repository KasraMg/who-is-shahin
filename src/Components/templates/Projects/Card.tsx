    ...
    return (
        <>
            ...
            <section className={`${i18n.language == 'fa' ? ' sm:pl-0 pl-24' : ' sm:pr-0 pr-24'} lg:w-[600px] sm:!w-full`}>
                ...
                <img className={`${i18n.language == 'fa' ? ' md:mr-16  sm:ml-auto  ml-16' : ' md:ml-16  sm:mr-auto  mr-6'} w-[700px] sm:!mx-auto sm:block sm:!w-[80%] sm-x2:!mx-auto   rounded-md relative z-50`} src={props.image} alt="" />
