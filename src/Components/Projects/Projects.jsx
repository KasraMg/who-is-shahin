...
export default function Projects() {
  ...
  return (
    <div style={{background:'url(/Images/projectBg.jpg)'}} className='relative pb-56 pt-36 md:pt-20  !bg-fixed !bg-center'>
       ...
       <Swiper rewind={true} navigation={true} modules={[Navigation]} className="mySwiper z-30 relative   ml-auto mr-0">
        {projects && projects.map(data=>(
            ...
            <section className='lg:w-[600px] pr-24'>
      ...
      <p className=' projects-title font-bold text-[120px] lg:right-12  uppercase absolute right-52 bottom-[42%]'>Projects</p>
