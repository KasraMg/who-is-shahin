...
export default function Footer() {
    ...
    return (
        ...
        <footer data-aos-duration="3000" id='footer' className='bg-[url(/Images/footer-bg.jpg)] bg-no-repeat border-t-2 md:bg-repeat-round  border-red-600 border-solid   pt-16 '>
            ...
            <p className='text-white text-3xl font-swap font-extrabold mt-5 text-center'>{t('footer.footer_title')}</p>

            <main className='flex sm-x2:!pb-4 gap-48 justify-center md:flex-col md:justify-center sm:!px-6 md:px-10 sm:pt-16  lg:gap-20 pt-32 pb-32'>
                <div>
        ...
        <div className='flex sm-x2:!px-6 lg:px-16 md:gap-20 relative gap-48 justify-center md:flex-col md:justify-center  py-20 bg-[url(/Images/softBg.jpg)]'>
                ...
                <Map />
                <div className="overlay " style={{ background: 'rgb(8 8 12 / 91%)' }}></div>
            </div>
