...
export default function Footer() {
    ...
    return (
        <footer data-aos="fade-right"   data-aos-duration="3000"  id='footer' className='bg-[url(/Images/footer-bg.jpg)] bg-no-repeat border-t-2 md:bg-repeat-round  border-red-600 border-solid   pt-16 '>
