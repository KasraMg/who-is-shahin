...
<div className="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
  ...
  <ul className='flex flex-col gap-10 font-swap     list-none z-30 relative' data-drawer-hide="drawer-example" aria-controls="drawer-example" >
        <a  href="#me"><li className='hover:text-red-500 transition-colors cursor-pointer  '>Who Am I ?</li></a>
        <a  data-drawer-hide="drawer-example" aria-controls="drawer-example" href="#skills"><li className='hover:text-red-500 transition-colors cursor-pointer  '>$kills</li></a>
        <a  data-drawer-hide="drawer-example" aria-controls="drawer-example" href="#projects"><li className='hover:text-red-500 transition-colors cursor-pointer  '>Projects</li></a>
        <a  data-drawer-hide="drawer-example" aria-controls="drawer-example" href="#footer"><li className='hover:text-red-500 transition-colors cursor-pointer  '>Talk To Me</li></a>
      </ul>
  </div>
