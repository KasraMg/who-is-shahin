...
export default function Header() {
  return (
    <header className='Header sm:px-3 text-white items-center flex justify-between flex-row-reverse py-4 px-10    '>
      <div>
      ...
      <RiMenu5Fill className='hidden sm:block text-3xl'/>
    </header>
  )
}
